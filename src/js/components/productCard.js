  ...
  return `
    <article class="product-card" data-product-id="${product.id}">
      <a class="product-card__media" href="/product/${product.id}">
        <img class="product-card__img" src="${imageUrl(product.image)}" alt="${escapeHtml(product.title)}" loading="lazy" />
      </a>
      ...
      <div class="product-card__info">
        ...
        <a class="product-card__title" href="/product/${product.id}">${escapeHtml(product.title)}</a>
