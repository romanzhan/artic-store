export function renderActions() {
  return `
    <div class="cta-actions">
      <button class="btn btn--filled cta-actions__cart" type="button" data-add-cart>
        <span class="cta-actions__full">Добавить в корзину</span>
        <span class="cta-actions__short">В корзину</span>
      </button>
      <button class="btn btn--primary btn--ghost-dark cta-actions__buy" type="button" data-buy-now>
