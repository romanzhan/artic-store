...
function renderInfo() {
  ...
  return `
    ...
    <div class="product__actions">
      <button class="btn btn--filled product__cart" type="button" data-add-cart>
        <span class="product__cart-full">Добавить в корзину</span>
        <span class="product__cart-short">В корзину</span>
      </button>
